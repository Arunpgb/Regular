...
public class JavascriptHelper extends BaseClass {
	...
	public void scrollToElement(WebElement element) {
		Loghelp.info("scroll to WebElement...");
	...
	public void scrollToElementAndClick(WebElement element) {
		...
		element.click();
		Loghelp.info("element is clicked: " + element.toString());
	}
	...
	public void scrollIntoView(WebElement element) {
		Loghelp.info("scroll till web element");
	...
	public void scrollDownVertically() {
		Loghelp.info("scrolling down vertically...");
	...
	public void scrollUpVertically() {
		Loghelp.info("scrolling up vertically...");
		executeScript("window.scrollTo(0,-document.body.scrollHeight)");
	}
